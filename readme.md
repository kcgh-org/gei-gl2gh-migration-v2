...
- When migration is selected at runtime, both repository migration and post-migration validation run together.
...
- Migration starts after environment validation
